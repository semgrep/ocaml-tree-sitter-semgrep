...
PYTHON_TESTS = lang/test_grammar_ts_version.py lang/test_ts_versions.py lang/test_abi15_gating.py lang/test_submodule_drift.py scripts/test_update_grammar.py
.PHONY: test-python
test-python:
