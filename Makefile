...
PYTHON_TESTS = lang/test_grammar_ts_version.py lang/test_ts_versions.py lang/test_abi15_gating.py scripts/test_update_grammar.py scripts/test_propose_grammar_update.py scripts/test_ensure_propose_result.py
.PHONY: test-python
test-python:
